...
# THIS METHOD WOULD BE BEST TO GATHER A RETURN FROM
...
# prints the data to the console in a formatted fashion
    def printData(self):
        ...
        data = self.getDataFormatted()

        # print data
        for stock in data:
            print("Stock Name:", stock[0])
            print("Latest Price: $" + stock[1])
            print("Previous Close: $" + stock[2])
            print("Lowest: $" + stock[3])
            print("Highest: $" + stock[4])
            print("Price Change: $" + stock[5])
            print("Percent Change:", stock[6])
            print("Date:", stock[7])
            print()
